...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(790, 428)
        MainWindow.setMinimumSize(QtCore.QSize(790, 428))
        MainWindow.setMaximumSize(QtCore.QSize(790, 428))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 0, 151, 385))
        ...
        self.periond_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.periond_label.setAlignment(QtCore.Qt.AlignCenter)
        self.periond_label.setObjectName("periond_label")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.periond_label)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.periond_start)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.periond_finish)
        self.categories_list = QtWidgets.QListWidget(self.formLayoutWidget)
        self.categories_list.setMinimumSize(QtCore.QSize(0, 209))
        self.categories_list.setObjectName("categories_list")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.categories_list)
        self.user_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.user_label.setAlignment(QtCore.Qt.AlignCenter)
        self.user_label.setObjectName("user_label")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.user_label)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.SpanningRole, self.change_user_button)
        self.show_query_button = QtWidgets.QPushButton(self.formLayoutWidget)
        self.show_query_button.setObjectName("show_query_button")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.show_query_button)
        self.items_table = QtWidgets.QTableView(self.centralwidget)
        self.items_table.setGeometry(QtCore.QRect(170, 20, 611, 331))
        self.items_table.setObjectName("items_table")
        self.add_item_button = QtWidgets.QPushButton(self.centralwidget)
        self.add_item_button.setGeometry(QtCore.QRect(630, 360, 151, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.periond_label.setText(_translate("MainWindow", "Period"))
