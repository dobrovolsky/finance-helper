...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(790, 460))
        MainWindow.setMaximumSize(QtCore.QSize(790, 460))
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.periond_label)
        ...
        self.items_table.setGeometry(QtCore.QRect(170, 10, 611, 351))
        self.items_table.setObjectName("items_table")
        self.add_item_button = QtWidgets.QPushButton(self.centralwidget)
        self.add_item_button.setGeometry(QtCore.QRect(630, 380, 151, 22))
