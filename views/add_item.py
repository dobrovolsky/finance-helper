...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_4.setMaximumSize(QtCore.QSize(83, 16777215))
        ...
        self.cancel_button.setGeometry(QtCore.QRect(99, 210, 91, 22))
        self.cancel_button.setObjectName("cancel_button")
        self.reset_button = QtWidgets.QPushButton(Dialog)
        self.reset_button.setGeometry(QtCore.QRect(10, 210, 80, 22))
        self.reset_button.setObjectName("reset_button")
        self.save_button_2 = QtWidgets.QPushButton(Dialog)
        self.save_button_2.setGeometry(QtCore.QRect(200, 210, 91, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_4.setText(_translate("Dialog", "Add category"))
        self.save_button.setText(_translate("Dialog", "Save"))
        self.cancel_button.setText(_translate("Dialog", "Cancel"))
        self.reset_button.setText(_translate("Dialog", "Reset"))
        self.save_button_2.setText(_translate("Dialog", "Save and exit"))
